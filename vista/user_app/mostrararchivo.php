			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Adjuntar documento</h4>						
					</div>
					<div class="row">
						...
						<div class="col-md-12">
                          ...
                          if (isset($_SESSION['id'])) {
							...
							$sql="SELECT cita.codcit, paciente.codpaci, paciente.nombrep, paciente.apellidop, doctor.coddoc, doctor.nombre, doctor.apellido, especialidad.codespe, especialidad.nombrees, cita.estado FROM cita INNER JOIN paciente ON cita.codpaci=paciente.codpaci INNER JOIN doctor ON cita.coddoc=doctor.coddoc INNER JOIN especialidad ON cita.codespe=especialidad.codespe WHERE paciente.codpaci='$id'";
						
							/*$sql = "SELECT cita.codcit, cita.dates, cita.hour, paciente.codpaci, 
												paciente.cedula, paciente.nombrep, paciente.apellidop, doctor.coddoc, doctor.cedula, doctor.nomdoc, 
												doctor.apedoc, especialidad.codespe, especialidad.nombrees, cita.estado FROM cita INNER JOIN paciente ON 
