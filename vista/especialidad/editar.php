		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form method="POST" action="../vista/especialidad/obtener.php?codespe=<?php echo $row['codespe']; ?>">
						...
						<input class="form-control" name="descripcion" type="hidden" value="<?php // echo $row->codespe; 
																							?>">
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group form-group-default">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<a href="../vista/especialidad/BorrarRegistro.php?codespe=<?php echo $row['codespe']; ?>" class="btn btn-danger"><span class="fa fa-times"></span> Eliminar</a>
				</div>
