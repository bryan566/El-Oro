	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form  method="POST" action="../vista/usuarios/obtener.php?id=<?php echo $row['id']; ?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="../vista/usuarios/BorrarRegistro.php?id=<?php echo $row['id']; ?>" class="btn btn-danger"><span class="fa fa-times"></span> Eliminar</a>
            </div>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form  method="POST" action="../vista/usuarios/password.php?id=<?php echo $row['id']; ?>">
