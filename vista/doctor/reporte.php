...
$display_heading = array('coddoc'=>'#', 'cedula'=> 'CEDULA', 'nomdoc'=> 'Nombres','apedoc'=> 'Apellidos','nombrees'=> 'Especialidad','telefo'=> 'Telefono', 'sexo'=> 'Sexo');

$result = mysqli_query($connString, "SELECT doctor.coddoc, doctor.cedula, doctor.nomdoc,doctor.apedoc,specialty.nombrees, doctor.sexo, doctor.telefo, doctor.fechanaci, doctor.correo, doctor.direccion, doctor.ciudad, doctor.naciona,doctor.estado, doctor.fecha_create FROM doctor INNER JOIN specialty ON doctor.codespe = specialty.codespe") or die("database error:". mysqli_error($connString));
...
$pdf->Cell($w[1],6,utf8_decode($row['cedula']),1);
