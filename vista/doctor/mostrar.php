...
<body>
								...
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											...
											<div class="u-text">
												<h4><?php // echo ucfirst($_SESSION['nombre']); 
													?></h4>
							...
							<div class="card">
								<div class="card-header">
									...
									<!--<div class="card-tools">
											<a href="../vista/doctor/reporte.php" class="btn btn-info btn-border btn-round btn-sm mr-2">
											...
											<table id="add-row" class="display table table-striped table-hover">
												...
												<tbody>
													...
													foreach ($dato as $key => $value) {
														foreach ($value as $va) { ?>
															<tr>
																<!--<td><?php // echo $va['coddoc'];
																		?></td>-->
																<!--<td><?php // echo $va['dnidoc'];
																		?></td>-->
																<td><?php echo $va['cedula']; ?></td>
																<td><?php echo $va['nombre']; ?>&nbsp;<?php echo $va['apellido']; ?></td>
																<td><?php echo $va['nombrees']; ?></td>
																<td><?php echo $va['ciudad']; ?></td>
																	...
																	<div class="form-button-action">
																		<button href="#editRowModal=<?php echo $va['coddoc']; ?>" title="" data-backdrop="false" class="btn btn-link btn-primary btn-lg" data-toggle="modal" data-target="#editRowModal<?php echo $va['coddoc']; ?>">
																			<!--<a href="#editRowModal_<?php // echo $va["coddoc"]; 
																										?>" title="" data-backdrop="false" class="btn btn-link btn-primary btn-lg" data-toggle="modal"><i class="fa fa-edit"></i></a>-->
																			<i class="fa fa-edit"></i>
																		</button>
																		<button href="#deleteRowModal=<?php // echo $va['coddoc']; 
																										?>" class="btn btn-link btn-danger btn-lg" data-toggle="modal" title="" data-original-title="Delete Task" data-target="#deleteRowModal<?php // echo $va['coddoc']; 																																															?>">
	...
	?>
		...
		?>
			...
			$sql2 = "INSERT INTO doctor(cedula,nombre,apellido,codespe,sexo,fechanaci,correo,telefono,direccion,ciudad,estado)VALUES ('$cedula','$nombre','$apellido','$codespe','$sexo','$telefono','$fechanaci','$correo','$direccion','$ciudad','1')";
